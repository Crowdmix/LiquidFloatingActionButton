...
@objc public protocol LiquidFloatingActionButtonDelegate {
    ...
    optional func openLiquidFloatingActionButton(liquidFloatingActionButton: LiquidFloatingActionButton)
    optional func closeLiquidFloatingActionButton(liquidFloatingActionButton: LiquidFloatingActionButton)
}
...
public class LiquidFloatingActionButton : UIView {
    ...
    @IBInspectable public var image: UIImage? {
        didSet {
            if image != nil {
                ...
                imageLayer!.frame = circleLayer.bounds
                plusLayer.hidden = true
            }
        }
    }
    ...
    private func didTapped() {
        if isClosed {
            open()
            delegate?.openLiquidFloatingActionButton?(self)
        } else {
            close()
            delegate?.closeLiquidFloatingActionButton?(self)
        }
    }
...
public class LiquidFloatingCell : LiquittableCircle {
    ...
    func setup(image: UIImage, tintColor: UIColor = UIColor.blackColor()) {
